...
An additional category for positive rsv but no medical attendance might be added for completeness.
...
Thus leverage on the historic information enters through the degree of shrinkage rather than directly through the likelihood.

Quantities such as risk difference and VE are then derived as functions of the above parameters.
...
These are based on a scenario when the treatment effect is an odds ratio of 0.7.
