...
+ Superiority 0.99, 0.97, 0.95 at the first, second and third analysis respectively and 
...
l_res <- qs::qread(file.path(output_dir_res, "20250402140442-sim-res.qs"))
...
l_res <- qs::qread(file.path(output_dir_res, "20250402142629-sim-res.qs"))
